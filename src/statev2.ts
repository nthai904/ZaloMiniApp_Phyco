...
import { Article, CartV2, Category, Delivery, OrderStatus, OrderV2, ProductV2, ShippingAddress, Station, UserInfo, Location } from "./typesv2";
...
export const ordersState = atomFamily((status: OrderStatus) =>
  atomWithRefresh(async () => {
    ...
    const allMockOrders = await requestWithFallback<OrderV2[]>("/orders", []);
